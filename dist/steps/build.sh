...
UNITY_SCRIPTING_DEFINE_SYMBOL="$GITHUB_WORKSPACE/$SCRIPTING_DEFINE_SYMBOL"
...
LINE_TO_WRITE=" 1: $UNITY_SCRIPTING_DEFINE_SYMBOL;$LINE_TO_CHECK"
...
if  grep -q "$STRING" "$PROJECT_SETTINGS_PATH" ; then
  sed 's/ARTEMIS/'"$UNITY_SCRIPTING_DEFINE_SYMBOL"'/g' $PROJECT_SETTINGS_PATH
  sed -i 's/ARTEMIS/'"$UNITY_SCRIPTING_DEFINE_SYMBOL"'/g' $PROJECT_SETTINGS_PATH
else
  sed '1: UNITY_POST_PROCESSING_STACK_V2'"1: UNITY_POST_PROCESSING_STACK_V2;$UNITY_SCRIPTING_DEFINE_SYMBOL"'/g' $PROJECT_SETTINGS_PATH
  sed -i '1: UNITY_POST_PROCESSING_STACK_V2'"1: UNITY_POST_PROCESSING_STACK_V2;$UNITY_SCRIPTING_DEFINE_SYMBOL"'/g' $PROJECT_SETTINGS_PATH
fi
#
# Build
#
